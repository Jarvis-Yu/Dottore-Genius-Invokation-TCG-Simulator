...
class TestAquilaFavonia(unittest.TestCase):
    def test_behaviour(self):
        ...
        self.assertEqual(p1c2.get_hp(), 5)
        self.assertEqual(p1c3.get_hp(), 5)
        
        game_state = skip_action_round(game_state, Pid.P1)
        game_state = step_skill(game_state, Pid.P2, CharacterSkill.SKILL1)
        p1c1, p1c2, p1c3 = game_state.get_player1().get_characters().get_characters()
        self.assertEqual(p1c1.get_hp(), 7)
        self.assertEqual(p1c2.get_hp(), 5)
        self.assertEqual(p1c3.get_hp(), 5)
        ...
        p1c1, p1c2, p1c3 = game_state.get_player1().get_characters().get_characters()
        active_id = game_state.get_player1().get_characters().get_active_character_id()
        ...
        p1c1, p1c2, p1c3 = game_state.get_player1().get_characters().get_characters()
        self.assertEqual(p1c1.get_hp(), 7)
        self.assertEqual(p1c2.get_hp(), 0)
        self.assertEqual(p1c3.get_hp(), 7)
