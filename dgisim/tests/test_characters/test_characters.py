...
class TestCharacters(unittest.TestCase):
    ...
    def test_get_character(self):
        characters = Characters.from_list([Kaeya, RhodeiaOfLoch, Tighnari])
    ...
    def test_find_first_character(self):
        characters = Characters.from_list([Kaeya, Tighnari, Tighnari])
    ...
    def test_get_active_character(self):
        chars = Characters.from_list([RhodeiaOfLoch, RhodeiaOfLoch, Keqing])
    ...
    def test_eq_and_hash(self):
        chars1 = Characters.from_list([RhodeiaOfLoch, RhodeiaOfLoch, Keqing])
        chars2 = Characters.from_list([RhodeiaOfLoch, RhodeiaOfLoch, Keqing])
        chars3 = Characters.from_list([Tighnari, RhodeiaOfLoch, Keqing])
