...
class TestWhenTheCraneReturned(unittest.TestCase):
    def test_behaviour(self):
        ...
        self.assertIn(WhenTheCraneReturnedStatus, game_state.player1.combat_statuses)
        ...
        self.assertNotIn(WhenTheCraneReturnedStatus, game_state.player1.combat_statuses)